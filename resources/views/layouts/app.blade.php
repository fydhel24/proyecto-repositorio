                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ul class="tg-header__top-right list-wrap">
                            <li>
                                <i class="flaticon-envelope"></i><a
                                    href="https://posgrado.upea.bo/">posgrado.upea.bo</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-content">
                        <span class="sub-title" data-aos="fade-up" data-aos-delay="0">POSGRADO</span>
                        <h2 class="title" data-aos="fade-up" data-aos-delay="200">
                            REPOSITORIO
                        </h2>
                        <p data-aos="fade-up" data-aos-delay="400">
                            Contamos con más de 200 programas a nivel Bolivia. Entre los cuales ofrecemos diplomados,
                    ...
                    <div class="banner-shape">
                        <img src="assets/img/banner/banner_shape01.png" alt="" class="rightToLeft" />
                        <img src="assets/img/banner/banner_shape02.png" alt="" class="ribbonRotate" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="footer-area">
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="footer-social">
                                        <ul class="list-wrap">
                                            <li>
                                                <a href="https://www.facebook.com/estudiaenposgradoupea/"><i
                                                        class="fab fa-facebook-f"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/posgradoupea"><i
                                                        class="fab fa-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/posgrado_upea/"><i
                                                        class="fab fa-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.limkedin.com/in/posgrado-upea-9324581a3/"><i
                                                        class="fab fa-pinterest-p"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.youtube.com/c/EstudiaenPosgradoUPEA/"><i
            ...
            <div class="footer-shape">
                <img src="assets/img/images/footer_shape01.png" alt="" data-aos="fade-right"
                    data-aos-delay="400" />
                <img src="assets/img/images/footer_shape02.png" alt="" data-aos="fade-left"
                    data-aos-delay="400" />
                <img src="assets/img/images/footer_shape03.png" alt=""
